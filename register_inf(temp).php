...
<h1>Register Now as an influencer!</h1>
<form name="Register" method="post" action="register_inf(temp).php">
    ...
    <div class="inner-wrap">
    <label>Platforms<br>
        <span style="font: 13px Arial, Helvetica, sans-serif;
    color: black;">
 ...
 <form name="Login" action="inf_login.php">
    <div class="button-section">
...
$inf_username=$_POST['username'];
$inf_username=strip_tags($inf_username);
$inf_username=str_replace(" ","",$inf_username);
$inf_age=$_POST['age'];
$inf_gender=$_POST['gender'];

$inf_email=$_POST['email'];
$inf_contact=$_POST['phone'];
...
$msg="";
if((strlen($inf_name)==0)||(strlen($inf_username)==0)||(strlen($inf_age)==0)||(strlen($inf_gender)==0)||(strlen($inf_platform)==0)||(strlen($inf_email)==0)||(strlen($inf_contact)==0)||(strlen($inf_avg_likes)==0)||(strlen($inf_genre)==0)||($inf_password!=$inf_password2)){
...
{
*/
$sql_u = "SELECT * FROM influencer WHERE inf_username='".$inf_username."'";
...
{
$sql = "insert into influencer(inf_username,inf_password,inf_name,inf_platform,inf_email,inf_contact,inf_age,inf_gender,inf_avg_likes,inf_genre)
