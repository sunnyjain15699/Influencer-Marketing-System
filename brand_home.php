...
<center>
	<h1 style="color: white" align="center"><i>Dashboard For Brands</i></h1>
	<div style="background: white;width: 70%;border-radius: 0px; height: 60%">

		<?php
  
    $query = "SELECT * FROM brand where brand_username='".$_SESSION['username']."'";
...
<table cellpadding="5px">
    ...
    <tr>
        <th>Brand Email : </th>
        <td> <?php echo "$brand_email"; ?> </td>
    </tr>

    <tr>
        <th>Brand Contact : </th>
        <td> <?php echo "$brand_contact"; ?> </td>
    </tr>
...
echo "</select>";
echo "<br>";
echo "<input id=\"but\" type=submit name=submit value=\"Find influencers in genre\">";
echo "</form>";
echo "</HTML>";
